 ...
 *
 * <pre>
 *     ClassHierarchy  Copyright (C) 2012-2021 Johann Tienhaara &lt;jtienhaara@yahoo.com&gt;
...
public class ClassHierarchy
{
    ...
    {
        System.out.println ( "" );
        System.out.println ( "ClassHierarchy  Copyright (C) 2012-2021 Johann Tienhaara <jtienhaara@yahoo.com>" );
        System.out.println ( "This program comes with ABSOLUTELY NO WARRANTY." );
        System.out.println ( "This is free software, and you are welcome to redistribute it" );
        System.out.println ( "under certain conditions; see GNU Public License version 3 for details at:" );
        ...
        implements MemberFilter
    {
         ...
         * </p>
         *
         * @param modifiers The modifier(s) to look for, logically
         *                  OR'ed together.
         */
        ...
        implements MemberListProcessor
    {
         ...
         * </p>
         *
         * @param member_orders The comparators that, one after the
         *                      other, decide the overall order of
         *                      output for members of a class.
         *                      For example: sort constants
         *                      alphabetically first, then sort
         *                      constructors alphabetically, then
         *                      sort methods alphabetically, then
         *                      sort public attributes alphabetically.
